...
- Five-minute test rounds are simulated. Set `AURASEA_ROUND_MS=0` for the live 24-hour schedule. `NANSEN_ENABLED=0` disables every Nansen call even when a key is present.
